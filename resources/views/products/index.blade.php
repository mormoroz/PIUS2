                            ...
                            <div class="card rounded-3 p-1">
                                <div class="card-body">
                                    <div class="product_title">
                                        ...
                                        <p class="h5 text-muted">{{$product->code}}</p>
                                    </div>
                                    <div class="border rounded-1 bg p-1 my-4 bg-cc-lighter">
                                        <div class="row">
                                            <p class="h4"><strong>Каллории:</strong><span class="h4 m-2"><strong>{{$product->description}}</strong></span></p>
                                            <p class="h6">Белки:<span class="h6 m-2">{{$product->price}}</span></p>
                                            <p class="h6">Жиры:<span class="h6 m-2">{{$product->count}}</span></p>
                                        </div>
                                    </div>
